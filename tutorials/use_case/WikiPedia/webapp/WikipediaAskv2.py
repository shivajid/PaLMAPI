...
st.image("https://ichef.bbci.co.uk/news/976/cpsprodpb/12DE1/production/_123218277_gettyimages-1368388509.jpg", width=130)
...
def ask( Question,tok):
  ...
  predictions_text =predict_large_language_model_sample(
      "demogct2022", "text-bison@001", 0.2, tok, 0.8, 40,
          prompt,
       "us-central1")
